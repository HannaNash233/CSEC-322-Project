...
class testCheckingAccount(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.checkAccount1 = CheckingAccount("John", "Johnson", 1000.00)
    ...
    def test_calculateInterest(self):
        interest1 = self.checkAccount2.calculateInterest()
        self.checkAccount2.withdraw(1500)
        self.assertEqual(self.checkAccount1.getBalance(), 1040.0)
        self.assertTrue(interest1)
        try:
            interest2 = self.checkAccount2.calculateInterest()
        except AssertionError:
            print("\nTesting negative account interest")
        if TestCheckingAccount.DEBUG:
            print("\nTesting Calculate Interest")
            print("Account 1 Balance: ", self.checkAccount1.getBalance())
