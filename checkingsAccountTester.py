...
class testCheckingAccount(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.checkingAccount1 = CheckingAccount(1000.00)
        self.checkingAccount2 = CheckingAccount(testCheckingAccount.INITIAL_BALANCE)
        
        
        
    def testConstructor(self):
        # Assert the initial balance is correct
        self.assertEqual(self.checkingAccount1.balance, 1000.00)
        # Assert that the initial transaction log entry was created
        self.assertGreater(len(self.checkingAccount1.transactions), 0)
        
        # Display details 
        print("\n--- Test Constructor Details ---")
        self.checkingAccount1.displayDetails()
    ...
    def testDisplayDetails(self):
        ...
        self.checkingAccount1.deposit(50.00)
        
        # Call the displayDetails method
        self.checkingAccount1.displayDetails()

        # Assertion that confirms there is data to display.
        self.assertGreater(len(self.checkingAccount1.transactions), 1)

    def testDeposit(self):
        # Record the initial transaction count
        initial_transaction_count = len(self.checkingAccount1.transactions)
        
        # Perform the deposit
        self.checkingAccount1.deposit(200.00)
        
        # Assert the balance updated correctly (1000 + 200 = 1200)
        self.assertEqual(self.checkingAccount1.balance, 1200.00)
        
        # Assert a new transaction was recorded
        self.assertEqual(len(self.checkingAccount1.transactions), initial_transaction_count + 1)
        
    def test_calculateInterest(self):
            interest1 = self.checkingAccount1.calculateInterest()
            self.checkingAccount2.withdraw(1000)
           # self.checkingAccount1.calculateInterest()
            #print("Balance: ", self.checkingAccount1.getBalance())
            self.assertEqual(self.checkingAccount1.getBalance(), 1015.0)
            self.assertTrue(interest1)
            
           # print(self.checkingAccount2.getBalance())
            try:
                interest2 = self.checkingAccount2.calculateInterest()
            except AssertionError:
                print("\nTesting negative account interest")
            if testCheckingAccount.DEBUG:
                print("\nTesting Calculate Interest")
                print("Account 1 Balance: ", self.checkingAccount1.getBalance())
            
    def test_withdraw(self):
        self.checkingAccount1.withdraw(100)
        try:
            self.checkingAccount2.withdraw(-100)
        except AssertionError:
            print("\nTesting Bad Withdraw (negative)")
                
            self.checkingAccount2.withdraw(1000)
        try:
            self.checkingAccount2.withdraw(200)
        except AssertionError:
    ...
    def test_printTransactions_success(self):
        # Arrange
        self.checkingAccount2.deposit(10.00)
            
        # Act/Assert: Verify method runs without error
        self.checkingAccount2.printTransactions()
        self.assertGreater(len(self.checkingAccount2.transactions), 0)
    ...
    def test_file_write_success(self):
        # Arrange
        self.checkingAccount2.deposit(50.00)
        
        # Act
        self.checkingAccount2.writeTransactions()
    ...
    def test_file_read_success(self):
        ...
        self.checkingAccount2.readTransactions()    
